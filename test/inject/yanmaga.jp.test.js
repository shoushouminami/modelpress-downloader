...
describe("Test suite yanmaga.jp.old", () => { 
    ...
    test("episodes/dee6ecf754844", async () => {
        await testDirectDownload(
            getBrowser(),
            "https://younganimal.com/episodes/dee6ecf754844",
            "younganimal.com-episodes-dee6ecf754844/",
            dummyItems(15)
        );
    });

    test("episodes/8454ea5786293", async () => {
        await testDirectDownload(
            getBrowser(),
            "https://youngchampion.jp/episodes/8454ea5786293",
            "youngchampion.jp-episodes-8454ea5786293/",
            dummyItems(5)
        );
    });
