...
test("article/330665", async () => {
    await testDirectDownload(
        ...
        [
            {
                prefix: "https://assets.friday.gold/friday-wp-production-assets/app/uploads/2025/04/WF0425_P096-10140048855848.jpg",
            },
            {
                prefix: "https://assets.friday.gold/friday-wp-production-assets/app/uploads/2025/04/WF0425_P097-10140050525758.jpg",
            }
        ]);
});
