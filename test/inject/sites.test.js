...
test("Test sites.all", () => {
    expect(sites.all().length).toBe(93);
    let hosts = [];
    let urls = [];
    ...
    expect(hosts).toContain("www.nogizaka46.com");
    ...
    expect(hosts).toContain("friday.kodansha.co.jp");
    expect(hosts).toContain("seventeen-web.jp");
    expect(hosts).toContain("withonline.jp");
    expect(hosts).toContain("entameclip.com");
    expect(hosts).toContain("cmnow.jp");
    expect(hosts).toContain("www.thefirsttimes.jp");
    expect(hosts).toContain("hanako.tokyo");
    expect(hosts).toContain("okmusic.jp");
    expect(hosts).toContain("www.cinemacafe.net");
    expect(hosts).toContain("25jigen.jp");
    ...
    expect(hosts).toContain("baila.hpplus.jp");
