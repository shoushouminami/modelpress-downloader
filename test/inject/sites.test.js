...
test("Test sites.all", () => {
    expect(sites.all().length).toBe(114);
    let hosts = [];
    let urls = [];
    ...
    expect(hosts).toContain("sirabee.com");
    ...
    expect(hosts).toContain("sweetweb.jp");
    expect(hosts).toContain("eiga.com");
    expect(hosts).toContain("tvbros.jp");
    expect(hosts).toContain("emomiu.jp");
    expect(hosts).toContain("www.lmaga.jp");
    expect(hosts).toContain("news.livedoor.com");
    ...
    expect(hosts).toContain("classy-online.jp");
    expect(hosts).toContain("www.billboard-japan.com");
    expect(hosts).toContain("korepo.com");
    expect(hosts).toContain("news.kstyle.com");
    expect(hosts).toContain("m.ex-m.jp");
    expect(hosts).toContain("www.tfm.co.jp");
    expect(hosts).toContain("trepo.jp");
    expect(hosts).toContain("www.fashionsnap.com");
    expect(hosts).toContain("www.koari.net");
