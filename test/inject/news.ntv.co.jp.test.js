...
describe("Test suite news.ntv.co.jp", () => {
    test("category/culture/0214f9501ed147ad80f3d715cbc0c079/image?p=1", async () => {
        await testDirectDownload(
            getBrowser(),
            "https://news.ntv.co.jp/category/culture/0214f9501ed147ad80f3d715cbc0c079/image?p=1",
            ...
            ],
            {
                preinject: async function (page) {
                    await pageutils.scrollTo(page, 30);
                }
            });
    });
