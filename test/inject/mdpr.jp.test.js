...
describe("Test suite mdpr.jp", () => {
    ...
    test("photo/detail/9929514", async () => {
        await testDirectDownload(
            getBrowser(),
            "https://mdpr.jp/photo/detail/9929514",
            "mdpr.jp-photo-detail-9929514/",
            [
                ...
                "https://img-mdpr.freetls.fastly.net/article/9FAw/nm/9FAwCTE4N_AKVrR-_mZwXaom4smBcokE23pGJhdrECo.jpg?quality=100"
            ]);
    });
});
